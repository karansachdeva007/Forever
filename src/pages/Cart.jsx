...
const Cart = () => {
  ...
  const handleRemoveProduct = (productId, size) => {
    updateQuantity(productId, size, 0);  // Update the cart to remove the product
    toast.info("Product removed");  // Show the toast notification
  };
        ...
        {cartData.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <img
                onClick={() => handleRemoveProduct(item._id, item.size)}  // Call the remove handler
